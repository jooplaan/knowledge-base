 ...
 * 
 * KNOWLEDGEB->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Knowledge_Bank_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		KNOWLEDGEB
 * @subpackage	Classes/Knowledge_Bank_Settings
 * @author		Joop Laan
 * @since		1.0.0
 */
class Knowledge_Bank_Settings{
	...
	/**
	 * Our Knowledge_Bank_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = KNOWLEDGEB_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'KNOWLEDGEB/settings/get_plugin_name', $this->plugin_name );
	}
}
